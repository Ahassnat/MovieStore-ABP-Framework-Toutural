...
namespace MovieStore.Migrations
{
    ...
    [Migration("20220613063725_Edit MoveActor CPK ActorId and MovieId")]
    partial class EditMoveActorCPKActorIdandMovieId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieStore.Actors.Actor", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("MovieStore.Genres.Genre", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MovieStore.Movies.Movie", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MovieStore.MoviesActors.MovieActor", b =>
                {
            ...
            modelBuilder.Entity("MovieStore.Movies.Movie", b =>
                {
                    b.HasOne("MovieStore.Genres.Genre", "Genre")
                        .WithMany()
            ...
            modelBuilder.Entity("MovieStore.MoviesActors.MovieActor", b =>
                {
                    b.HasOne("MovieStore.Actors.Actor", null)
                        .WithMany("Movies")
                        .HasForeignKey("ActorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MovieStore.Movies.Movie", null)
                        .WithMany("Actors")
